...
void lessThanRequired (char *text, int *lengthOfText){
    //TODO
    printf("The length of your text is less than specified, please update your text\n");
    printf("Length Before: %d", strlen(text));
    *lengthOfText = MIN_LENGTH;
}

void equalThanRequired (char *text, int *lengthOfText){
    //TODO
    *lengthOfText = strlen(text);
    printf("Thank you, Your text length is correct");
}

void moreThanRequired (char *text, int *lengthOfText){
    //TODO
...
int main() {
    ...
    void (*functions[3])(char *, int *) = {lessThanRequired, equalThanRequired, moreThanRequired};
    functions[selectOption](text, &lengthOfText);
    // TODO
